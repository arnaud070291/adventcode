...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec  1 16:02:12 2023
...
"""
import re as variable11


variable1 = 0
variable2 = ["one","two","three","four","five","six","seven","eight","nine"]
variable2 = {x : str(i+1) for (i,x) in enumerate(variable2) }

for variable0 in variable.split("\n") : 
    variable3 = 100000000000000000000
    variable4 = -1
    variable5 = 10000
    variable6 = 10000
    try :
        for variable12 in variable2:  
            if variable12 in variable0 : 
                variable10 =  variable0.index(variable12)
                if variable10 > variable4 : 
                    variable4 = variable10
                    variable6 = variable12
                if variable10 < variable3 : 
                    variable3 = variable10
                    variable5 = variable12
        if variable5  in variable2 :
            variable0 = variable0.replace(str(variable5),variable2[str(variable5)])
        if variable6 in variable2 :
            variable0 = variable0.replace(str(variable6),variable2[str(variable6)])    
        variable13 = variable11.findall("[0-9]",variable0)
        variable7 = int(variable13[0]+variable13[-1])
        variable1+=variable7
    except : 
        pass
print(variable1)
